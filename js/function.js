            ...
            $.post(URLGET, compra ,(respuesta, estado) => {
                ...
                if(estado === "success"){
                    ...
                    Swal.fire({
                        ...
                        text: `Este es un emprendimiento ficticio. Luego se le enviará a u correo un enlace y se le permitiría pagar tu compra mediante mercado pago u otro método.`,
